...
public class Boss2Collision implements CollisionListener {

    private GameLevel level;
    private Game game;
    private static SoundClip bossTouchSound;

    public Boss2Collision(GameLevel level, Game game){
        this.level = level;
        this.game = game;
    }
    ...
    public void collide(CollisionEvent e) {
        if (e.getOtherBody() instanceof Boss2 && level.isComplete()) {
